...
Kirigami.ApplicationWindow {
    ...
    function downloadComplete(xhr) {
        ...
        console.log(dataView.getUint8(0).toString(16))
        console.log(dataView.getUint8(1).toString(16))
        console.log(dataView.getUint8(2).toString(16))
        console.log(dataView.getUint8(3).toString(16))
